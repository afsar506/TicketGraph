...
public class FilterServiceImpl implements FilterService {
	...
	public Map<String, Long> tasktype() {
		...
		Map<String, Long> res = dbRes.stream()
				.collect(Collectors.groupingBy(Filter::getTaskType,
						Collectors.counting()));
		return res;
	}
	...
	public int priorityConfiguration(PriorityConfigurationRequestDto configurationRequestDto) {
		List<Filter> dbRes = filterRepository.findByPriorityAndConfiguration(configurationRequestDto.getPriority(),configurationRequestDto.getConfiguration());
	...
	public Map<String, Long> state() {
		List<Filter> dbRes = filterRepository.findAll();
		Map<String, Long> res = dbRes.stream()
				.collect(Collectors.groupingBy(Filter::getState,
						Collectors.counting()));
	...
	public Map<String, Long> priority() {
		List<Filter> dbRes = filterRepository.findAll();
		Map<String, Long> res = dbRes.stream()
				.collect(Collectors.groupingBy(Filter::getPriority,
						Collectors.counting()));
		System.out.println(res);
		return res;
	}
	...
	public Map<String, Long> assignmentGroup() {
		List<Filter> dbRes = filterRepository.findAll();
		Map<String, Long> res = dbRes.stream()
				.collect(Collectors.groupingBy(Filter::getAssignmentGroup,
						Collectors.counting()));
		System.out.println(res);
		return res;
	}
	...
	public Map<String, Long> configurationItem() {
		List<Filter> dbRes = filterRepository.findAll();
		Map<String, Long> res = dbRes.stream()
				.collect(Collectors.groupingBy(Filter::getConfigurationItem,
						Collectors.counting()));
		System.out.println(res);
		return res;
	}
...
/*		Map<String, Long> res = dbRes.stream() 
	...
	public int taskTypeConfiguration(ConfigItemAndTaskTypeRequestDto taskTypeRequestDto) {
		List<Filter> dbRes = filterRepository.findByTaskTypeAndConfiguration(taskTypeRequestDto.getTaskType(),taskTypeRequestDto.getConfiguration());
		return dbRes.size();
	}
